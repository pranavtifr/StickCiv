...
; StickCiv Tileset, units by Bobomax, based off of Apolyton
; Scenario League.

; Special thanks go to:
;TheGreatestKhan and Canik for helping refine some of the units
;Fuzzy, JSA, Andreasgrad for support
;Panch93 for helping with the github stuff
artists = "
    Alex Mor [Alex]
...
tiles = { "row", "column", "tag"
  ...
  0,  2, "u.battleship"		; [Bobomax]
  0,  3, "u.bomber"		; [Bobomax]
